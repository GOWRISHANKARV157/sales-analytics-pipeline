...
export type StorageHash =
  StorageHashBase<'24adf0eb12fb35554c522bae93cdc8ea5a1cceb3a7202ef160efb418de0fe096'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly RegionAnalytics: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly uploadId: CodecTypes['pg/int4@1']['output'];
      readonly region: CodecTypes['pg/text@1']['output'];
      readonly revenue: CodecTypes['pg/float8@1']['output'];
    };
    readonly TopTransaction: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly uploadId: CodecTypes['pg/int4@1']['output'];
      readonly transactionId: CodecTypes['pg/text@1']['output'];
      readonly region: CodecTypes['pg/text@1']['output'];
      readonly category: CodecTypes['pg/text@1']['output'];
      readonly netAmount: CodecTypes['pg/float8@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly TopTransaction: {
      ...
      readonly region: CodecTypes['pg/text@1']['input'];
      readonly category: CodecTypes['pg/text@1']['input'];
      readonly netAmount: CodecTypes['pg/float8@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly categoryAnalytics: {
              ...
              indexes: readonly [
                {
                  readonly name: 'categoryAnalytics_uploadId_idx_9cfc848c';
                  readonly prefix: 'categoryAnalytics_uploadId_idx';
                  readonly columns: readonly ['uploadId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'categoryAnalytics';
                    readonly columns: readonly ['uploadId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly dailyRevenue: {
              ...
              indexes: readonly [
                {
                  readonly name: 'dailyRevenue_uploadId_idx_9cfc848c';
                  readonly prefix: 'dailyRevenue_uploadId_idx';
                  readonly columns: readonly ['uploadId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'dailyRevenue';
                    readonly columns: readonly ['uploadId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly regionAnalytics: {
              ...
              indexes: readonly [
                {
                  readonly name: 'regionAnalytics_uploadId_idx_9cfc848c';
                  readonly prefix: 'regionAnalytics_uploadId_idx';
                  readonly columns: readonly ['uploadId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'regionAnalytics';
                    readonly columns: readonly ['uploadId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly topTransaction: {
              ...
              indexes: readonly [
                {
                  readonly name: 'topTransaction_uploadId_idx_9cfc848c';
                  readonly prefix: 'topTransaction_uploadId_idx';
                  readonly columns: readonly ['uploadId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'topTransaction';
                    readonly columns: readonly ['uploadId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly regionAnalytics: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'RegionAnalytics';
    };
    readonly categoryAnalytics: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'CategoryAnalytics';
    };
    readonly topTransaction: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'TopTransaction';
    };
    readonly dailyRevenue: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'DailyRevenue';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          ...
          readonly CategoryAnalytics: {
            ...
            readonly storage: {
              readonly table: 'categoryAnalytics';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly uploadId: { readonly column: 'uploadId' };
          ...
          readonly RegionAnalytics: {
            ...
            readonly storage: {
              readonly table: 'regionAnalytics';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly uploadId: { readonly column: 'uploadId' };
